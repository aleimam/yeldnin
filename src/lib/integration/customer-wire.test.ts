...
describe("parseWireCustomer", () => {
  it("accepts a valid registered customer", () => {
    expect(parseWireCustomer({ veeeyCustomerId: "VC-123", name: "Ali Hassan", phone: "+20100", archived: false })).toEqual({
  ...
  it("phone is optional; archived defaults false", () => {
    expect(parseWireCustomer({ veeeyCustomerId: "VC-1", name: "Ada" })).toEqual({ veeeyCustomerId: "VC-1", name: "Ada", phone: null, archived: false });
  });
