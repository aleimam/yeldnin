    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          <button onClick={() => goMonth(shiftMonth(month, -1))} className="btn-secondary px-2 py-1" aria-label={t("common.prev")}><span className="rtl-flip">‹</span></button>
          <span className="min-w-28 text-center font-semibold text-ink">{month}</span>
          <button onClick={() => goMonth(shiftMonth(month, 1))} className="btn-secondary px-2 py-1" aria-label={t("common.next")}><span className="rtl-flip">›</span></button>
        </div>
